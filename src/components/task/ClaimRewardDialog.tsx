 ...
 * 3. 第三步：輸入身分證驗證身分
 */
export function ClaimRewardDialog({ reward, isOpen, onClose, onConfirm }: ClaimRewardDialogProps) {
  ...
  return (
    <ThreeStepDialog isOpen={isOpen} config={config} onClose={onClose} onConfirm={handleConfirm} />
  );
}
