 ...
 *
 * 為什麼要有這個元件:自訂服務類別上線後,類別長度不再由開發者決定,而這四處
 * 原本各自貼 CSS、零機械驗證。收斂成一個元件之後,「有寬度界限」由建構保證,
 * 一支測試守四個地方。
 *
 * 界限不能靠「上限夠小」來省掉:新輸入的上限雖已收到 6 字
 * (`CUSTOM_CATEGORY_MAX_LENGTH`,對齊內建最長值),調降前建立的類別最長仍有
 * 10 字並持續出現在畫面上,資料層的濫用上界更是 20 字。
 *
 * 界限由三件事湊成,缺一不可:
 ...
 * 4 個全形字——連「寵物美容」這種 4 字類別都放不下,直接違背長度上限的設計前提。
 *
