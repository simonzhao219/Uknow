...
import type { NotificationConfig } from './NotificationCard';
...
export function NotificationProvider({ children }: NotificationProviderProps) {
  ...
  const showToast = useCallback(
    (message: string, type: ToastType = 'info', options?: Partial<ToastConfig>) => {
  ...
  return (
    <NotificationContext.Provider value={value}>
      ...
      {/* Notification Card */}
      {notification && <NotificationCard {...notification} onClose={closeNotification} />}
