      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">複製您的專屬推薦碼，分享給親朋好友</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">好友使用您的推薦碼成功訂閱</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">好友成功訂閱服務後，您即可獲得 $10 獎金</p>
          </div>
        </div>
