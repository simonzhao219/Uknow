...
export function RewardStats({ availableRewards, pendingRewards, withdrawnRewards, totalEarned }: RewardStatsProps) {
  // 如果有 totalEarned 就使用它，否則計算總和（向後兼容）
  const totalRewards = totalEarned !== undefined ? totalEarned : availableRewards + pendingRewards + withdrawnRewards
