...
| 4 | 系統告警與公告手機版（＋P15 公告內文、P16 管理員設置 Email） | ✅ 綠 | 見 git log | |
| 5 | 驗收棘輪歸零（admin 的 8 條 `known_overflow` ＋ 3 條 xfail marker 全清） | ✅ 綠（隨階段 1–4 逐步清完） | — | |
...
| 3 會員管理手機版 | `b83368b` | `9161aef` |
| 4 告警／公告／管理員設置 | 見 git log | （本 commit） |
| 5 驗收棘輪歸零 | — | 隨階段 1–4 逐步清完 |
