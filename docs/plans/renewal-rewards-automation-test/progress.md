...
|---|---|---|---|---|
| 1 | 時光機三原語+離線純函式測試 | ⬜ 未開始 | | |
| 2 | saga cast+builder 接線+feature 第 1–2 章 | ⬜ 未開始 | | |
| 3 | 第 3–4 章(補繳 extend、fresh 清空+A14/A15) | ⬜ 未開始 | | |
| 4 | 第 5–7 章(B 樹、Q9 擋 fresh、S9+Q14a) | ⬜ 未開始 | | |
| 5 | 第 8–10 章(credit/A8、A10-fresh、終章對帳) | ⬜ 未開始 | | |
...
規劃書已寫,待 `/review-plan` 審查與人審裁決(開放問題 #1–#6)。
未開工。
